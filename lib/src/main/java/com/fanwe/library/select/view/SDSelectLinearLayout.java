...
public class SDSelectLinearLayout extends LinearLayout
{
    public SDSelectLinearLayout(Context context)
    {
        super(context);
        init();
    }

    public SDSelectLinearLayout(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        init();
    }

    public SDSelectLinearLayout(Context context, AttributeSet attrs, int defStyleAttr)
    {
